...
public class RewardController: ISwitchableRewardController, IDisposable
{
    ...
    public RewardController(List<RewardView> rewardViews, CurrencyWindow currencyWindow)
    {
    ...
    private void RefreshUi()
    {
        ...
        {
            _curentRewardView.Slots[i].SetData(_curentRewardView.Rewards[i], i+1, i < _curentRewardView.CurrentActiveSlot, i == _curentRewardView.CurrentActiveSlot);
        }
    ...
    private void InitSlots(RewardView rewardView)
    {
        ...
        for (int i = 0; i < rewardView.Rewards.Count; i++)
        {
            ...
            slotInstance.SetData(reward, i+1, false, false);
    ...
    private void ClaimReward()
    {
        ...
        switch (reward.Type)
        {
            ...
            case RewardType.Wood:
                _currencyWindow.AddWood(reward.Count);
                break;
            case RewardType.Diamond:
                _currencyWindow.AddDiamond(reward.Count);
                break;
            default:
